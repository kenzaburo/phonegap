    ...
    var SearchExample = React.createClass({displayName: "SearchExample",
      ...
      render: function() {
              ...
              if(libraries.length == 0){
                ...
                collwordList=React.createElement("div", {className: "content"}, 
                                React.createElement("div", {className: "notify"}, 
                                  React.createElement("i", null, " No collocation words")
                                )
                              )
              }else{
          ...
          { 
            ...
            collwordList=React.createElement("div", {className: "content backgroudColor"}, 
              React.createElement("div", {className: "notify"}, 
                React.createElement("p", null, React.createElement("img", {src: "img/background.jpg", className: "img-intro"}))
              ), 
        ...
        return React.createElement("div", {className: "container"}, 
                      React.createElement("header", {className: "bar bar-nav header-nav-bar"}, 
                        React.createElement("h1", {className: "title app-title"}, 
                          React.createElement("strong", null, "English Collocation Dictionary")
                        )
                      ), 
